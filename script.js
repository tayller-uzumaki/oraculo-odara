...
// Calculadora de Odù pela Numerologia Ancestral
...
document.getElementById('form-odu')?.addEventListener('submit', function (e) {
  ...
  setTimeout(() => {
    ...
    // Texto Expandido com Mínimo de 5 Linhas, Pontos Fortes e Pontos de Alerta
...
// Gerador do Vetor SVG dos Búzios
...
document.getElementById('form-consulta')?.addEventListener('submit', function (e) {
  ...
  // Sequência Mística de Transição
  ...
  // Exibição Final dos Resultados Estruturados
  setTimeout(() => {
    perguntasRestantes--;
    document.getElementById('qtd-perguntas').innerText = perguntasRestantes;
