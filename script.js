...
const ODUS_DATABASE = {
  ...
  2: {
    ...
    pontosAtencao: ["Indecisão paralensante", "Dependência da opinião alheia", "Medo de posicionamento"],
  ...
  10: {
    ...
    pontosAtencao: ["Prepotência", "Violá princípios éticos", "Isolamento"],
...
document.getElementById('form-consulta')?.addEventListener('submit', function (e) {
  ...
  setTimeout(() => {
    ...
    resContainer.innerHTML = `
      ...
      <!-- 3. Interpretação Aplicada à Pergunta -->
      ...
      <!-- 4. Influências Espirituais Associadas -->
      <div style="margin: 16px 0; background: #0b0612; padding: 14px; border-radius: 8px; border: 1px solid #332147;">
      ...
      <!-- 5 & 6. Fatores Favoráveis e Pontos de Atenção -->
